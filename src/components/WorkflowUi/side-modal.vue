          ...
          <div class='ant-row-flex ant-row-flex-middle editable-text-field'>
            ...
            <div class='ant-col ant-col-7'>
              ...
              ><svg
                ...
                aria-hidden='true'
              ><path
                d='M884 256h-75c-5.1 0-9.9 2.5-12.9 6.6L512 654.2 227.9 262.6c-3-4.1-7.8-6.6-12.9-6.6h-75c-6.5 0-10.3 7.4-6.5 12.7l352.6 486.1c12.8 17.6 39 17.6 51.7 0l352.6-486.1c3.9-5.3.1-12.7-6.4-12.7z' /></svg></i></span></div></div><i
              ...
              ><path
                ...
                d='M464 336a48 48 0 1 0 96 0 48 48 0 1 0-96 0zm72 112h-48c-4.4 0-8 3.6-8 8v272c0 4.4 3.6 8 8 8h48c4.4 0 8-3.6 8-8V456c0-4.4-3.6-8-8-8z' /></svg></i></span>
            </div>
          </div>
        </div>
        <div
