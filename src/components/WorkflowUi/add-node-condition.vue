<template>
  <div v-if='show1' class='side-modal-wrapper'>
...
import ConditionAddBtn from './condition-add-btn.vue'
...
export default {
  ...
  methods: {
    ...
    save() {
      ...
      const flag = this.properties.conditions[0].every(cond => {
